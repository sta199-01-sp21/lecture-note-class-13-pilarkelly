...
```{r data_manhattan}
manhattan <- read_csv("~/R/lecture-note-class-13-pilarkelly/manhattan.csv")
```
...
I am 95% confident that the interval 2299-2982 includes the true mean of rent for 1 bedroom apartments in manhattan. 
...
I am 95% confident that the true value of the median price of 1 bedroom apartments in Manhattan is in the interval of (2162, 2875). 
...
We are 95% confident that the true proportion of mice that died while not on the treatment is withing the interval of (0.690, 0.797)
...
```{r practice_2_ci}
ci_mice_live <- get_ci(boot_prop_live, level=0.9)
ci_mice_live
...
visualize(boot_prop_live) +
  shade_ci(ci_mice_live)
```

Give an interpretation of your result.

I am 90% confidence that the true proportion of mice that lived while on 
the treatment is in the interval (0.552, 0.651).
